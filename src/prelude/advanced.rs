...
// raw Unis types (generated by the Uni builders)
// TODO 2023-06-14: why not take this opportunity to unify `UniBuilder`s & `Uni`s? This would simplify the typings for the network class, but would require a major version upgrade. An intermediate version, upgrading only the middle version, might be issued in the interin, for tests
pub type RawUniMoveAtomic<InType,
                       const BUFFER_SIZE: usize,
                       const MAX_STREAMS: usize = 1,
                       const INSTRUMENTS: usize = {Instruments::LogsWithMetrics.into()}>
    = uni::Uni<'static, InType, ChannelUniMoveAtomic<InType, BUFFER_SIZE, MAX_STREAMS>, INSTRUMENTS, InType>;
pub type RawUniMoveCrossbeam<InType,
                          const BUFFER_SIZE: usize,
                          const MAX_STREAMS: usize = 1,
                          const INSTRUMENTS: usize = {Instruments::LogsWithMetrics.into()}>
    = uni::Uni<'static, InType, ChannelUniMoveCrossbeam<InType, BUFFER_SIZE, MAX_STREAMS>, INSTRUMENTS, InType>;
pub type RawUniMoveFullSync<InType,
                         const BUFFER_SIZE: usize,
                         const MAX_STREAMS: usize = 1,
                         const INSTRUMENTS: usize = {Instruments::LogsWithMetrics.into()}>
    = uni::Uni<'static, InType, ChannelUniMoveFullSync<InType, BUFFER_SIZE, MAX_STREAMS>, INSTRUMENTS, InType>;
pub type RawUniZeroCopyAtomic<InType,
                     const BUFFER_SIZE: usize,
                     const MAX_STREAMS: usize = 1,
                     const INSTRUMENTS: usize = {Instruments::LogsWithMetrics.into()}>
    = uni::Uni<'static, InType, ChannelUniZeroCopyAtomic<InType, BUFFER_SIZE, MAX_STREAMS>, INSTRUMENTS, OgreUnique<InType, AllocatorAtomicArray<InType, BUFFER_SIZE>>>;
pub type RawUniZeroCopyFullSync<InType,
                             const BUFFER_SIZE: usize,
                             const MAX_STREAMS: usize = 1,
                             const INSTRUMENTS: usize = {Instruments::LogsWithMetrics.into()}>
    = uni::Uni<'static, InType, ChannelUniZeroCopyFullSync<InType, BUFFER_SIZE, MAX_STREAMS>, INSTRUMENTS, OgreUnique<InType, AllocatorFullSyncArray<InType, BUFFER_SIZE>>>;
