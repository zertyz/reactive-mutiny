...
pub type OgreFullSyncMPMCQueue<'a, ItemType,
                                   const BUFFER_SIZE: usize = 1024,
                                   const MAX_STREAMS: usize = 16>
        = InternalOgreFullSyncMPMCQueue<'a, ItemType,
                                            BUFFER_SIZE,
                                            MAX_STREAMS>;
...
pub struct InternalOgreFullSyncMPMCQueue<'a, ItemType:          Send + Sync + Debug,
                                             const BUFFER_SIZE: usize,
                                             const MAX_STREAMS: usize> {

    streams_manager: Arc<StreamsManagerBase<'a, ItemType, FullSyncMeta<Option<Arc<ItemType>>, BUFFER_SIZE>, MAX_STREAMS, MAX_STREAMS, Option<Arc<ItemType>>>>,
}

impl<'a, ItemType:          Send + Sync + Debug + 'a,
         const BUFFER_SIZE: usize,
         const MAX_STREAMS: usize>
InternalOgreFullSyncMPMCQueue<'a, ItemType, BUFFER_SIZE, MAX_STREAMS> {
...
for*/ InternalOgreFullSyncMPMCQueue<'a, ItemType, BUFFER_SIZE, MAX_STREAMS> {
...
mod tests {
    ...
    async fn multiple_streams() {
        ...
        let channel = Arc::new(OgreFullSyncMPMCQueue::<u32, 128, PARALLEL_STREAMS>::new("multiple_streams"));
